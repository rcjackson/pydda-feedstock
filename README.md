...
Once the `conda-forge` channel has been enabled, `pydda` can be installed with:

```
conda install pydda
```

It is possible to list all of the versions of `pydda` available on your platform with:
